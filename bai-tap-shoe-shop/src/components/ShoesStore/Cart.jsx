...
export default function Cart({ cartListProp }) {
    const renderListCart = () => {
        return cartListProp.map((cartItem) => (
            <tr key={cartItem.id} className="border-b last:border-b-0">
                ...
                <td className="py-4">
                    <div className="flex items-center">
                        <button className="border border-gray-200 rounded-md py-2 px-4 mr-2">-</button>
                        <span className="text-center w-8">{cartItem.quantity}</span>
                        <button className="border border-gray-200 rounded-md py-2 px-4 ml-2">+</button>
                    </div>
                </td>
